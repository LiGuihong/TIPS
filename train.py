...
from timm.data import create_loader, resolve_data_config, AugMixDataset
...
from dyn_slim.apis import train_epoch_slim, validate_slim
...
parser.add_argument('--extra_sample_prob', type=float, default=0.0)
...
def main():
    ...
    model = create_model(
        ...
        extra_sample_prob=args.extra_sample_prob)
